...
var fight = function() {
    ...
    // remove enemy's health by subtracting the vlaue of 'playerAttack' from the vlaue of 'enemyHealth' and use that result to update the value in 'enemyHealth' variable
